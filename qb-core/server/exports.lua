...
local function ExploitBan(playerId, origin)
    ...
    TriggerEvent("Rc2-log:server:CreateLog", "anticheat", "Anti-Cheat", "red", name .. " has been banned for exploiting " .. origin, true)
end
...
exports('AddQBResource', function(name)
    if not QBCore.QBResources[name] then 
        QBCore.QBResources[name] = true
    end
end)